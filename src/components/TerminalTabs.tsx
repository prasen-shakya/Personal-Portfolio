...
export function TerminalTabs({ activePage, onSelect }: TerminalTabsProps) {
  const baseTabClassName =
    "flex-none cursor-pointer border-0 px-4 py-[0.15rem] whitespace-nowrap transition-colors duration-150 outline-none focus-visible:outline focus-visible:outline-1 focus-visible:outline-terminal-blue focus-visible:outline-offset-[-1px] max-[640px]:min-h-9 max-[640px]:px-3";
  ...
  return (
    <header>
      ...
      <nav
        className="flex items-stretch overflow-x-auto overflow-y-hidden whitespace-nowrap bg-terminal-surface0 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
      ...
      >
        ...
        <div className="flex-1 bg-terminal-surface0 max-[480px]:hidden" aria-hidden="true" />
      </nav>
